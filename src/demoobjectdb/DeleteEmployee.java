...
public class DeleteEmployee extends javax.swing.JFrame {
    ...
    private void okBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okBtnActionPerformed
        int employee = Integer.parseInt(idInput.getText());
        gestor.getTransaction().begin();
        TypedQuery<Employee> consulta = gestor.createQuery("SELECT i FROM Employee i WHERE i.ID = "
        ...
        if (resultados.size() == 0) {
            ...
            gestor.getTransaction().begin();
            Employee victima = resultados.get(0);
